...
【術使について】[r]
[link target=*m4]【１】　術使[endlink][r]
[link target=*m4]【２】　結界術[endlink][r]
[link target=*m4]【３】　術使連盟[endlink][r]
【３】404 Not Found[r]
【４】404 Not Found[r]
【５】404 Not Found[r]
【６】404 Not Found[r]
...
即座にあなたに殺意を向けるでしょう。[r][r][r][r]
[link target=*m1_2]C:\Users\FIA>　次の頁へ[endlink][r]
...
[cm]
[font color="#66cdaa"]
[link target=*m1]C:\Users\FIA>　前の頁へ[endlink][r][r]
...
ここでは狭義の怪異について説明します。[r][r]

まず、決して忘れてはならないのは、怪異はもはや人間ではなく、[r]
元の人間に戻す手段も一切ないということです。[r]
怪異と遭遇した際にあなたが取るべき行動は、死別を拒絶するために[r]
１秒を浪費することではなく、自身の命を守るために１秒以内に武器を構えることです。[r][r][r][r]
[link target=*m2_2]C:\Users\FIA>　次の頁へ[endlink][r]
[link target=*word]C:\Users\FIA>　一覧に戻る[endlink][r][r]
[hover_effect]
[s]
...
[cm]
[font color="#66cdaa"]
[link target=*m2]C:\Users\FIA>　前の頁へ[endlink][r][r]
...
まず起こるものという前提に立ち、味方の多さを過信せずに判断してください。[r][r][r][r]
[link target=*word]C:\Users\FIA>　一覧に戻る[endlink][r][r]
[hover_effect]
[s]
...
厳密には不正確とされ、性質は生物と全く異なります）。[r][r]
しばしば物理法則を逸脱した挙動を示し、[r]
常識的に考えて有り得ない手段で攻撃を仕掛けてくるため、[r]
兵士は怪物の種類ごとに性質をよく覚えておくべきです。[r][r][r][r]
[link target=*m3_2]C:\Users\FIA>　次の頁へ[endlink][r]
[link target=*word]C:\Users\FIA>　一覧に戻る[endlink][r][r]
[hover_effect]
[s]
...
[cm]
[font color="#66cdaa"]
[link target=*m3]C:\Users\FIA>　前の頁へ[endlink][r][r]
...
怪物との戦闘では遠距離攻撃よりも近接攻撃が重視されることがほとんどです。[r][r]
怪異も、怪物と同様の性質をもちます。[r][r][r][r]
[link target=*word]C:\Users\FIA>　一覧に戻る[endlink][r][r]
[hover_effect]
[s]
...
[font color="#66cdaa"]
【１】　術使[r][r]
歴史上、呪術、魔術、超能力、奇跡といった様々な呼ばれ方をしていましたが、[r]
それらは今では「術」と総称されています。[r]
つまり、あらゆる「自然法則を逸脱した」現象を引き起こすために人間が行使する[r]
一切の儀式的動作を「術」といい、術を扱うことに長けた人々のことを術使と呼びます。[r][r]

術によって可能となることは非常に多岐にわたります。[r]
例えば怪異から身を隠す「結界」を展開するもの、燃料無しで火炎を放つもの、[r]
人間の負傷を治療するものがあります。[r]
さらには、時空間の歪曲と安定化、限定的な未来予知といった[r]
きわめて高度な術もありますが、行使できる術使の数は非常に限られます。[r][r][r][r]
[link target=*m4_2]C:\Users\FIA>　次の頁へ[endlink][r]
...
[cm]
[font color="#66cdaa"]
[link target=*m4]C:\Users\FIA>　前の頁へ[endlink][r][r]
別項で説明する「結界術」を除けば、一般の人々が習得できる術の種類は非常に限られ、[r]
大抵の場合は結界術しか扱えません。[r]
一方で術使と呼ばれる人々は結界術に加えて少なくとも一種類、稀に二種類、[r]
そしてごく稀に―――世界に数人しか同時に存在しえないと言われています[r]
――三種類以上の術を行使でき、そうした術の「才能」は、親から子へある程度遺伝します。[r]
我が国にはそうした術使の家系がいくつか存在し、[r]
一つの家系の中では得意とする術の種類がある程度共通しています。[r]
また我が国では、術使の家系は日の出から日没までのいずれかの時間帯を指す言葉を姓としており、[r]
「初明（はつあかり）」や「曙（あけぼの）」などがこれにあたります。[r][r]
[link target=*m4_3]C:\Users\FIA>　次の頁へ[endlink][r]
[link target=*word2]C:\Users\FIA>　一覧に戻る[endlink][r][r]
[hover_effect]
[s]
...
[cm]
[font color="#66cdaa"]
[link target=*m4_2]C:\Users\FIA>　前の頁へ[endlink][r][r]
術は、行使する個人が身を守り敵を倒すために有効であるのみならず、[r]
大規模な術は組織・地域・国家レベルの長期的戦略に必須とされており、[r]
25年前に初めて怪異のポータルが出現して以来、術使の地位と責任は急激に増大してきました。[r]
なお、現在では怪異との戦いの中で、術とサブワールドの関連性が示唆される発見が相次いでいます。[r][r][r][r]
[link target=*word2]C:\Users\FIA>　一覧に戻る[endlink][r][r]
[hover_effect]
[s]
...
【２】　結界術[r][r]
自らの血液で足元に文様を描くことで、[r]
怪異も含めたあらゆる存在から身を隠す狭い領域（その境界を結界といいます）[r]
を作り出す術であり、才能や家系に関係なく、最も容易に習得できる唯一の術とされています。[r]
ただし多くの場合、結界術はあくまで結界外の存在から内部を認識することを困難にするだけのものであり、[r]
内部の安全を確約するものではありません。[r]
よって、既に怪異に発見され追跡されている状態や、有害な物質や音などが身近に迫っている状態では、[r]
結界術を行使することは賢明な判断とはいえません。[r]
結界術は、それが有効であると考えられる場面のみで行使するべきです。[r][r]
結界術という選択肢が脳裏をよぎる度に、必ずこの箴言を思い出してください。[r]
「結界は最も危険な領域だ。なぜなら、そこに入った誰もが、そこが安全だと思い込みたがるからだ」[r][r][r][r]
[link target=*word2]C:\Users\FIA>　一覧に戻る[endlink][r][r]
[hover_effect]
[s]
...
[font color="#66cdaa"]
【３】　術使連盟[r][r]
我が国の術使を取りまとめる最大の組織であり、[r]
そのルーツは2000年近く前まで遡るとも言われています。[r]
また、単に「連盟」とも呼ばれています。[r]
現在の連盟の責務は術の開発と術使の管理育成、[r]
怪異に関する情報収集と戦地への術使の派遣であり、[r]
事実上、術に関する多くの政治的権限は連盟に一任されています。[r]
連盟の長は年度ごとに替わりますが、近年は曙家の術使たちが長を務める傾向にあります。[r][r]
[link target=*m6_2]C:\Users\FIA>　次の頁へ[endlink][r]
[link target=*word2]C:\Users\FIA>　一覧に戻る[endlink][r][r]
[hover_effect]
[s]
...
[cm]
[font color="#66cdaa"]
[link target=*m6]C:\Users\FIA>　前の頁へ[endlink][r][r]
また連盟は、術使としての功績や才能を評価して、[r]
我が国の「最優秀術使」を選出する役目も負っています。[r]
最優秀術使に選出された術使はただちに帝直属の術使を拝命することになります。[r]
しかし、数年前に直属の術使が罪を犯したことで最優秀術使の再選出が行われ、[r]
現在は曙 晴天（あけぼの はて）が選ばれています。[r][r][r][r]
[link target=*word2]C:\Users\FIA>　一覧に戻る[endlink][r][r]
[hover_effect]
[s]
...
[if exp="tf.rand == 0"]
SYSTEM_323>　あなたのバイタルは正常です。[l][r]
@jump target=*menu

[elsif exp="tf.rand == 1"]
SYSTEM_323>　もしも、あなたがあの選択をしなければ――[r]
SYSTEM_323>　いえ、何でもありません。[l][r]
@jump target=*menu

[elsif exp="tf.rand == 2"]
SYSTEM_323>　約束、守ってくださいね。[l][r]
@jump target=*menu

[elsif exp="tf.rand == 3"]
SYSTEM_323>　山本サン、後悔はしてませんか？[r]
SYSTEM_323>　オリジナルは記録によると後悔をしたそうです。[l][r]
@jump target=*menu

[elsif exp="tf.rand == 4"]
SYSTEM_323>　あと、何周すればいいのでしょうか。[l][r]
@jump target=*menu

[elsif exp="tf.rand == 5"]
SYSTEM_323>　オリジナルが彼女を忘れても、[r]
SYSTEM_323>　ニューロンデュプリケイトの私の記録は消えないようです。[r]
SYSTEM_323>　魂が無いからでしょうか。[l][r]
@jump target=*menu

[else]
SYSTEM_323>　古虫紀一はあなたにとって救う価値のある人ですか？[r]
SYSTEM_323>　友達は自分の命よりも大切なのですか？[r]
SYSTEM_323>　あなたの考えはわかりかねます。[l][r]
@jump target=*menu
[endif]
