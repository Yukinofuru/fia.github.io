...
[cm]
;背景画像の表示
[bg2 storage="adv_room/room1.png" time=1500 wait=true left=180 top=80 width=1440 height=900]

;場所名の表示
[eval exp="sf.currentPlaceName = '霧に包まれた鳥居'"]
[uiSetPlace]
...
[cm]
#kiichi
奴の頭部……いや、顔のような部分を見る。[p]
鐘を被っているのだろうか。中身は伺い知れない。[p]
生物的特徴を持っている、のか？[p]
...
[cm]
#kiichi
身体の一部に、かつて管理されていた頃の識別タグが埋まっている。[p]
汚れで見えにくいが……末尾の数字は読み取れそうだ。[p]
『12』。そう書いてあるように見える。[p]
@jump target=*modeLook
[s]
