...
var $black_mask = $('<div id="custom_awake_mask" style="position:absolute;top:0;left:0;width:100%;height:100%;background-color:black;z-index:9999999;"></div>');
$("body").append($black_mask);
setTimeout(function(){
    $("#custom_awake_mask").fadeOut(500, function(){
        $(this).remove();
    });
}, 200);
[endscript]
