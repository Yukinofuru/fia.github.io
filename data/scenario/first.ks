...
; マクロ設定
;=========================================
[macro name="set_place"]
[free name="place" layer="message0" time="100"]
...
[macro name="ch_show"]
[chara_show name="%name" layer="message0" face="normal" time=10 left=209 top=912 width=290 height=290 zindex=101]
[endmacro]

[macro name="ch_hide"]
[chara_hide name="%name" layer="message0" time=10]
[endmacro]
...
;文字が表示される領域を調整
[position layer=message0 page=fore margint="980" marginl="500" marginr="110" marginb="60"]
...
;キャラクターの名前が表示される文字領域
[ptext name="chara_name_area" layer="message0" color="white" size=34 bold=false x=510 y=920]
