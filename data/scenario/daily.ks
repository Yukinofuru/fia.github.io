...
[uiDestroy]
[chara_ptext name=""] 
[bg2 storage="date.png" time=0 wait=true left=180 top=80 width=1440 height=900]
@layopt layer=message1 visible=true
[current layer="message1"]

; --- 1. 月（固定）と「古い日（前日）」を表示する ---
[ptext name="date_month" layer="message1" text="&sf.displayMonth" x="357" y="169" size="410" color="#ffffffff"]
[ptext name="old_day"    layer="message1" text="&sf.oldDay"       x="832" y="169" size="410" color="#ffffffff"]
...
[if exp="sf.dayCount == 1"]
    [jump storage="0_1.ks"]
[elseif exp="sf.dayCount == 5"]
    [jump storage="game_over.ks"]
[elseif exp="sf.dayCount == 6"]
    [jump storage="0_5.ks"]
[elseif exp="sf.dayCount == 10"]
